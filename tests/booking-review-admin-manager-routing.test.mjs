...
test('review api exposes manager routing query types and methods', () => {
...
test('manager routing page exists and renders routing truth fields', () => {
  ...
  assert.match(pageSource, /contactMobile/);
});
