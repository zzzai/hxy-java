...
public interface ErrorCodeConstants {
    ...
    ErrorCode TICKET_SLA_RULE_NOT_EXISTS = new ErrorCode(1_011_000_121, "SLA 工单规则不存在");
    ErrorCode TICKET_SLA_RULE_SCOPE_DUPLICATE = new ErrorCode(1_011_000_122, "SLA 工单规则范围重复，请调整后重试");
    ErrorCode TICKET_SLA_RULE_SCOPE_STORE_REQUIRED = new ErrorCode(1_011_000_123, "门店作用域规则必须指定有效门店");
