...
(
    ...
    "spu_id"             bigint,
    "sku_id"             bigint,
    "child_code"         varchar  NOT NULL DEFAULT '',
    "sku_name"           varchar  NOT NULL DEFAULT '',
    "quantity"           int      NOT NULL DEFAULT 1,
    "pay_price"          int      NOT NULL DEFAULT 0,
    "refunded_price"     int      NOT NULL DEFAULT 0,
    ...
    "deleted"            bit      NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_trade_order_item_bundle_child_order_item_child_code"
        UNIQUE ("order_item_id", "child_code", "deleted")
) COMMENT '交易订单套餐子项台账表';
...
(
    ...
    "route_scope"       varchar  NOT NULL DEFAULT '',
    "route_decision_order" varchar NOT NULL DEFAULT '',
...
(
    ...
    "notify_type"      varchar  NOT NULL DEFAULT '',
    ...
    "last_error_msg"   varchar  NOT NULL DEFAULT '',
    "last_action_code" varchar  NOT NULL DEFAULT '',
    "last_action_biz_no" varchar NOT NULL DEFAULT '',
    "last_action_time" datetime          DEFAULT NULL,
    "creator"          varchar           DEFAULT '',
    ...
    "deleted"          bit      NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_trade_after_sale_review_ticket_notify_outbox_biz_key" UNIQUE ("biz_key")
