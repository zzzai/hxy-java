...
public class AfterSaleReviewTicketEscalationJob implements JobHandler {
    ...
    private static final String CONFIG_KEY_JOB_DEFAULT_LIMIT = "hxy.trade.review-ticket.sla.job.batch-limit.default";
    private static final String CONFIG_KEY_JOB_MAX_LIMIT = "hxy.trade.review-ticket.sla.job.batch-limit.max";
