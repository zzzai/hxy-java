...
public interface AfterSaleReviewTicketMapper extends BaseMapperX<AfterSaleReviewTicketDO> {
    ...
    default PageResult<AfterSaleReviewTicketDO> selectPage(AfterSaleReviewTicketPageReqVO reqVO) {
        LambdaQueryWrapperX<AfterSaleReviewTicketDO> queryWrapper = new LambdaQueryWrapperX<AfterSaleReviewTicketDO>()
                ...
                .eqIfPresent(AfterSaleReviewTicketDO::getResolverId, reqVO.getResolverId())
                .eqIfPresent(AfterSaleReviewTicketDO::getResolverType, reqVO.getResolverType())
                .eqIfPresent(AfterSaleReviewTicketDO::getResolveActionCode, reqVO.getResolveActionCode())
                .eqIfPresent(AfterSaleReviewTicketDO::getResolveBizNo, reqVO.getResolveBizNo())
