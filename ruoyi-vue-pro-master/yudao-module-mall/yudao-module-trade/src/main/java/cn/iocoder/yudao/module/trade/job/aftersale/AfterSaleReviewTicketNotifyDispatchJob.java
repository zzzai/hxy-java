 ...
 */
@Component
public class AfterSaleReviewTicketNotifyDispatchJob implements JobHandler {

    private static final String CONFIG_KEY_JOB_DEFAULT_LIMIT = "hxy.trade.review-ticket.sla.notify.job.batch-limit.default";
    private static final String CONFIG_KEY_JOB_MAX_LIMIT = "hxy.trade.review-ticket.sla.notify.job.batch-limit.max";
    ...
    public String execute(String param) {
        ...
        int count = afterSaleReviewTicketService.dispatchPendingNotifyOutbox(limit);
        return String.format("分发人工复核工单通知出站 %s 条", count);
    }
