...
@Component
public class BookingReviewNotifyDispatchJob implements JobHandler {
    ...
    public String execute(String param) {
        int count = bookingReviewNotifyOutboxService.dispatchPendingNotifyOutbox(parseLimit(param));
        return String.format("派发预约评价通知 %s 条", count);
    }
