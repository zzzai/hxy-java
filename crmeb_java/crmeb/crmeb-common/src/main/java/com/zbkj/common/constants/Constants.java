...
//    public static final String CONFIG_KEY_PUBLIC_LOGO = "wechat_avatar"; //公众号logo
    ...
    public static final String SERVICE_PAY_TYPE_BOOKING = "booking"; //服务预约
    ...
    public static final String ORDER_LOG_REFUND_AUTO_SUBMIT = "refund_auto_submit"; //自动秒退提交
    public static final String ORDER_LOG_REFUND_TICKET = "refund_ticket"; //总部退款工单
