...
mapping_placeholder_count="$(kv "${latest_mapping_audit_summary}" "placeholder_count")"
...
mapping_placeholder_count="${mapping_placeholder_count:-0}"
...
if ! [[ "${mapping_placeholder_count}" =~ ^[0-9]+$ ]]; then mapping_placeholder_count=0; fi
...
if [[ -n "${latest_mapping_audit_summary}" && "${mapping_placeholder_count}" -gt 0 ]]; then risk_count=$((risk_count + 1)); fi
...
mapping_placeholder_count=${mapping_placeholder_count}
...
| mapping_audit(latest) | N/A | overall=${mapping_overall}, critical=${mapping_critical_count}, warn=${mapping_warn_count}, placeholder=${mapping_placeholder_count} |
...
| latest mapping_audit critical/warn/placeholder | ${mapping_critical_count}/${mapping_warn_count}/${mapping_placeholder_count} |
