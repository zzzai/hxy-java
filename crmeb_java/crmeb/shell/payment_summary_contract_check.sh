...
ops_status_summary="$(latest_summary "${RUNTIME_ROOT}/payment_ops_status")"
...
check_contract "ops_status" "${ops_status_summary}" \
  "run_id" "overall" "warn_count" "block_count" "mapping_smoke_summary" "mapping_smoke_summary_age_minutes" "mapping_smoke_overall"
...
check_contract "store_mapping_audit" "${store_map_audit_summary}" \
  "run_id" "overall" "critical_count" "warn_count" "missing_count" "invalid_count" "duplicate_store_count" "orphan_non_empty_count" "placeholder_count" "placeholder_file" "run_dir"
check_contract "cutover_gate" "${cutover_gate_summary}" \
  "run_id" "report_date" "overall" "gate_decision" "block_count" "warn_count" "preflight_rc" "preflight_fail_items" "mapping_overall" "mock_replay_overall" "go_nogo_decision" "ops_status_overall" "run_dir"
...
ops_status_summary=${ops_status_summary}
...

{
  ...
  echo "- ops_status_summary: \`${ops_status_summary}\`"
