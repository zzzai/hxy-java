    ...
    public Boolean checkPayType(String payType){
        ...
        switch (payType){
            case PayConstants.PAY_TYPE_WE_CHAT:
                result = ConfigSwitchUtil.isOn(systemConfigService.getValueByKey(SysConfigConstants.CONFIG_PAY_WEIXIN_OPEN));
                break;
            case PayConstants.PAY_TYPE_YUE:
                result = ConfigSwitchUtil.isOn(systemConfigService.getValueByKey(SysConfigConstants.CONFIG_YUE_PAY_STATUS));
                break;
            case PayConstants.PAY_TYPE_ALI_PAY:
                result = ConfigSwitchUtil.isOn(systemConfigService.getValueByKey(SysConfigConstants.CONFIG_ALI_PAY_STATUS));
                break;
        }
        return result;
    }
