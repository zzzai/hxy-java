...
public interface WechatNewService {
    ...
    /**
     * 微信预下单接口(按配置自动选择v2/v3)
     * @param unifiedorderVo 预下单请求对象
     * @param payConfig 渠道支付配置
     * @return 微信预下单返回对象
     */
    CreateOrderResponseVo payUnifiedorder(CreateOrderRequestVo unifiedorderVo, WeChatPayChannelConfig payConfig);
    ...
    /**
     * 微信支付查询订单(按配置自动选择v2/v3)
     * @param outTradeNo 商户订单号
     * @param payConfig 渠道支付配置
     * @return 支付订单查询结果
     */
    MyRecord payOrderQuery(String outTradeNo, WeChatPayChannelConfig payConfig);
     ...
     * @return 是否关闭成功
     */
    Boolean payOrderClose(String outTradeNo, WeChatPayChannelConfig payConfig);

    /**
     * 微信退款查询
     * @return 退款查询结果
     */
    MyRecord payRefundQuery(Map<String, String> payVo);
     ...
     * @return 退款查询结果
     */
    MyRecord payRefundQuery(String outRefundNo, WeChatPayChannelConfig payConfig);
     ...
     * @return 申请退款结果对象
     */
    WxRefundResponseVo payRefund(WxRefundVo wxRefundVo, WeChatPayChannelConfig payConfig);
