...
//    private PayComponentOrderService componentOrderService;
    ...
    public Boolean queryPayResult(String orderNo) {
        ...
        if (pre.equals("order")) {// 支付订单
            ...
            // 生成查询订单对象
            Map<String, String> payVo = getWxChantQueryPayVo(wechatPayInfo.getOutTradeNo(), payConfig);
            // 查询订单信息
...
//                }
        ...
        // 生成查询订单对象
        Map<String, String> payVo = getWxChantQueryPayVo(userRecharge.getOutTradeNo(), payConfig);
        // 查询订单信息
        MyRecord record = wechatNewService.payOrderQuery(payVo);
        // 支付成功处理
