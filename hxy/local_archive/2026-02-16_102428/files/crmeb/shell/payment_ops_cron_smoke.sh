...
expect_contains "cutover_gate" "payment_cutover_gate.sh --require-apply-ready 0 --require-booking-repair-pass 1 --mapping-strict-missing 0 --require-mapping-green 0 --require-mock-green 0 --owner-default payment-ops --owner-p1 payment-oncall"
