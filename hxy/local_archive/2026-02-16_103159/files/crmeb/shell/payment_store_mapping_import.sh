...
usage() {
  cat <<'EOF'
用法：
  ./shell/payment_store_mapping_import.sh --csv /path/store_submchid.csv [--apply] [--confirm] [--strict-submchid-unique] [--strict-submchid-format] [--conflict-strategy block|overwrite]
