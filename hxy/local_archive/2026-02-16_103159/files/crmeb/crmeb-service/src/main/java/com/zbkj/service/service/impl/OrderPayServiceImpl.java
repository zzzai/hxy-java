...
//        temMap.put("thing5", "恭喜您拼团成功！我们将尽快为您发货。");
    ...
    private Map<String, String> unifiedorder(StoreOrder storeOrder, String ip) {
        ...
        map.put("appId", StrUtil.isNotBlank(payConfig.getClientAppId()) ? payConfig.getClientAppId() : unifiedorderVo.getAppid());
        ...
        String paySign = WxPayUtil.getSign(map, payConfig.getSignKey());
