...
public class ServiceBookingServiceImpl implements ServiceBookingService {
    ...
    private ServiceBookingOrderResponse createInLock(Integer uid, ServiceBookingCreateRequest request) {
        ...
        mutation.getTargetSlot().put("status", "locked");
        mutation.getTargetSlot().put("orderNo", orderNo);
        mutation.getTargetSlot().put("lockedExpire", now + LOCK_EXPIRE_SECONDS);
        ...
        order.setOffpeakDiscount(BigDecimal.ZERO);
