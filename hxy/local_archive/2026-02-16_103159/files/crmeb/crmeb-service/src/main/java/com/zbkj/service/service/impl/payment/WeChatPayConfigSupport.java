...
public class WeChatPayConfigSupport {
    ...
    public WeChatPayChannelConfig resolveByChannel(Integer channel, Integer storeId) {
        ...
        boolean providerMode = StrUtil.isNotBlank(spMchId) || StrUtil.isNotBlank(spSignKey);
        ...
        if (StrUtil.hasBlank(spMchId, spSignKey)) {
            throw new CrmebException("服务商模式配置不完整，请检查：" + profile.spMchIdKey + "、" + profile.spSignKeyKey);
        }
    ...
    private static class ChannelProfile {
        ...
        private ChannelProfile(String baseAppIdKey, String baseMchIdKey, String baseSignKey, String baseCertPathKey,
                               ...
                               String subMchIdPrefix, String subMchIdDefaultKey, String subAppIdPrefix, String subAppIdDefaultKey) {
