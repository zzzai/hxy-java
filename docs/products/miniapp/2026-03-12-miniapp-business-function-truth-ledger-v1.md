...
| BF-020 | Booking | 预约列表 / 预约详情 | `/pages/booking/order-list`; `/pages/booking/order-detail` | `GET /booking/order/list`; `GET /booking/order/get`; `AppBookingOrderController` | ACTIVE | `docs/products/miniapp/2026-03-09-miniapp-booking-schedule-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-acceptance-and-recovery-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-release-evidence-review-v1.md` | 完整 | 否 | B/C/D 正式产出已把订单查询页、字段、恢复动作与 runbook 边界全部落盘；当前仍只按 query-only `ACTIVE` 管理 |
| BF-021 | Booking | 技师列表 / 技师详情 / 时段查询 | `/pages/booking/technician-list`; `/pages/booking/technician-detail` | `GET /booking/technician/list`; `GET /booking/technician/get`; `GET /booking/slot/list-by-technician`; `AppTechnicianController`; `AppTimeSlotController` | ACTIVE | `docs/products/miniapp/2026-03-09-miniapp-booking-schedule-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-acceptance-and-recovery-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-release-evidence-review-v1.md` | 完整 | 否 | 当前分支代码已完成 canonical 绑定，且 B 产品、C contract、D runbook 已共同确认这部分只属于 query-only `ACTIVE` |
| BF-022 | Booking | 预约创建 | `/pages/booking/technician-list`; `/pages/booking/technician-detail`; `/pages/booking/order-confirm` | `GET /booking/technician/list`; `GET /booking/slot/list-by-technician`; `POST /booking/order/create`; `AppTechnicianController`; `AppTimeSlotController`; `AppBookingOrderController` | PLANNED_RESERVED | `docs/products/miniapp/2026-03-09-miniapp-booking-schedule-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-acceptance-and-recovery-prd-v1.md`; `docs/contracts/2026-03-15-miniapp-booking-runtime-release-evidence-contract-v1.md`; `docs/plans/2026-03-15-miniapp-booking-runtime-release-runbook-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-release-evidence-review-v1.md` | 完整 | 部分 | 当前代码/测试/gate 与 B/C/D 正式口径都已允许继续开发，但 shared chain 仍输出 `can_release=NO`；缺 success/failure release 样本包与巡检证据，create 继续阻断放量 |
| BF-023 | Booking | 预约取消 | `/pages/booking/order-list`; `/pages/booking/order-detail` | `POST /booking/order/cancel`; `AppBookingOrderController` | PLANNED_RESERVED | `docs/products/miniapp/2026-03-09-miniapp-booking-schedule-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-acceptance-and-recovery-prd-v1.md`; `docs/contracts/2026-03-15-miniapp-booking-runtime-release-evidence-contract-v1.md`; `docs/plans/2026-03-15-miniapp-booking-runtime-release-runbook-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-release-evidence-review-v1.md` | 完整 | 部分 | canonical 取消路径已对齐，失败分支也已冻结；B/C/D 正式口径共同确认当前只是不再阻断真值修复开发，仍继续阻断 release-ready / 放量 |
| BF-024 | Booking | 加钟 / 升级 | `/pages/booking/addon` | `POST /app-api/booking/addon/create`; `AppBookingAddonController` | PLANNED_RESERVED | `docs/products/miniapp/2026-03-09-miniapp-booking-schedule-prd-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-acceptance-and-recovery-prd-v1.md`; `docs/contracts/2026-03-15-miniapp-booking-runtime-release-evidence-contract-v1.md`; `docs/plans/2026-03-15-miniapp-booking-runtime-release-runbook-v1.md`; `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-release-evidence-review-v1.md` | 完整 | 部分 | add-on 当前分支已对齐到 `/app-api` 前缀并冻结失败分支；B/C/D 正式口径共同确认它仍缺发布级 success/failure 样本和真实运行证据，不能当成可放量能力 |
...
2. 当前最强阻断不再是 booking 旧 path 漂移，而是 booking 写链路 release proof、member 缺页能力、reserved 规划能力和后台运营财务闭环。
...
6. `docs/products/miniapp/2026-03-14-miniapp-runtime-blocker-final-integration-v1.md` 与 `docs/products/miniapp/2026-03-15-miniapp-booking-runtime-release-evidence-review-v1.md` 已把 `Booking / BO-004 / Member 缺页 / Reserved runtime` 的最终阻断口径统一固定为“可进入真值修复开发，不可直接放量”。
